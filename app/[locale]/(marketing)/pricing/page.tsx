        ...
        <div className="flex flex-col min-h-[calc(100vh-80px)] bg-slate-50">
            ...
            <section className="px-4 pb-20 max-w-5xl mx-auto w-full grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm flex flex-col hover:shadow-md transition-shadow">
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold text-slate-900">{t("studentTitle")}</h2>
                        <p className="text-slate-500 mt-2">{t("studentSubtitle")}</p>
                    </div>

                    <div className="mb-8 flex items-baseline text-slate-900">
                        <span className="text-5xl font-extrabold">{t("studentPrice")}</span>
                    </div>

                    <ul className="space-y-4 mb-8 flex-1">
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-emerald-500 mr-3 shrink-0" />
                            <span className="text-slate-600">{t("studentFeat1")}</span>
                        </li>
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-emerald-500 mr-3 shrink-0" />
                            <span className="text-slate-600">{t("studentFeat2")}</span>
                        </li>
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-emerald-500 mr-3 shrink-0" />
                            <span className="text-slate-600">{t("studentFeat3")}</span>
                        </li>
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-emerald-500 mr-3 shrink-0" />
                            <span className="text-slate-600">{t("studentFeat4")}</span>
                        </li>
                    </ul>
                ...
                <div className="bg-sky-600 rounded-3xl p-8 border border-sky-500 shadow-xl flex flex-col text-white relative overflow-hidden">
                    ...
                    <div className="mb-6 relative z-10">
                        ...
                        <h2 className="text-2xl font-bold">{t("instructorTitle")}</h2>
                        <p className="text-sky-100 mt-2">{t("instructorSubtitle")}</p>
                    </div>

                    <div className="mb-2 flex items-baseline relative z-10">
                        <span className="text-5xl font-extrabold">{t("instructorPrice")}</span>
                        <span className="text-xl text-sky-200 ml-2">{t("instructorPriceUnit")}</span>
                    </div>
                    ...
                    <ul className="space-y-4 mb-8 flex-1 relative z-10">
                        <li className="flex items-start">
                            ...
                            <span className="text-sky-50">{t("instructorFeat1")}</span>
                        </li>
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-sky-200 mr-3 shrink-0" />
                            <span className="text-sky-50">{t("instructorFeat2")}</span>
                        </li>
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-sky-200 mr-3 shrink-0" />
                            <span className="text-sky-50">{t("instructorFeat3")}</span>
                        </li>
                        <li className="flex items-start">
                            <Check className="h-5 w-5 text-sky-200 mr-3 shrink-0" />
                            <span className="text-sky-50">{t("instructorFeat4")}</span>
                        </li>
                    </ul>
